...
class FilteringConfig(_Section):
    """k-core filtering applied before splitting."""
...
class SplittingConfig(_Section):
    """Temporal split protocol. See ADR-002."""

    strategy: Literal["temporal_global", "temporal_per_user", "leave_one_out"] = "temporal_global"
